...
* demo for self-adjustable resolution by making a fast reading (7 ms) and adjusting the resolution based on it
...
void loop() {
    ...
    bhSensor.Set_Highest_Resolution_From_Range(bhSensor.Get_Read_Lux() * 1.1); // use fast reading (+10% ) to set max range
