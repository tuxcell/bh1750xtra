...
* demo for testing the methods that change the resolution according to Measurement Time, Measurement Time Register value and Range
...
void setup() {
    ...
    //bhSensor.Set_Highest_Resolution_From_Measurement_Time(100); // highest resolution measurements for a particular measurement time in ms
    //bhSensor.Set_Highest_Resolution_From_MTreg(55); // highest resolution measurements for a particular MTreg(measurement time register)
    bhSensor.Set_Highest_Resolution_From_Range(85000); // highest resolution measurement for the max range in lx
